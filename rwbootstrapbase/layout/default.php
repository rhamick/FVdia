<?php
// This file is part of The RW Bootstrap 3 Moodle theme
//
...
$regions = rwbootstrapbase_grid($hassidepre, $hassidepost);
$PAGE->set_popup_notification_allowed(false);
if ($knownregionpre || $knownregionpost) {
    theme_rwbootstrapbase_initialise_zoom($PAGE);
}
$setzoom = theme_rwbootstrapbase_get_zoom();
