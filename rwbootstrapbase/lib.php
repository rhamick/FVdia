<?php
// This file is part of The rwbootstrapbase 3 Moodle theme
//
...
/**
 * Renderers to align Moodle's HTML with that expected by rwbootstrapbase
 *
 * @package    theme_rwbootstrapbase
 * @copyright  2015 RW
...
function rwbootstrapbase_grid($hassidepre, $hassidepost) {
 ...
 */
function theme_rwbootstrapbase_initialise_zoom(moodle_page $page) {
    user_preference_allow_ajax_update('theme_rwbootstrapbase_zoom', PARAM_TEXT);
    $page->requires->yui_module('moodle-theme_rwbootstrapbase-zoom', 'M.theme_rwbootstrapbase.zoom.init', array());
}

/**
 * Get the user preference for the zoom function.
 */
function theme_rwbootstrapbase_get_zoom() {
    return get_user_preferences('theme_rwbootstrapbase_zoom', '');
}